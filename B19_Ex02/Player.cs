...
namespace B19_Ex02
{
    ...
    {
        // $G$ CSS-999 (-3) variable name should be starting with s_PascaleCased
        // $G$ CSS-999 (-3) enum names should be PascaleCased
        HUMAN = 0,
        COMPUTER = 1,
    }

    // $G$ DSN-999 (-3) Better use a struct here
    // $G$ CSS-999 (-3) each non nested Class/Enum/Interface should be in a separate file
