    ...
    public partial class OtheloGame : Form
    {
        ...
        protected override void OnShown(EventArgs e)
        {
            ...
            if (m_FormLogin.DialogResult == DialogResult.OK)
            {
                ...
                Text = string.Format("Othello- {0}'s turn!", m_OtheloGame.CurrPlayer.Name);
        ...
        private void initializeOtheloBoard()
        {
            ...
            Size = new Size(30 + (50 * m_FormLogin.BoardSize), 50 + (50 * m_FormLogin.BoardSize));
            m_GroupBoxForMatrix.Size = new Size(50 * m_FormLogin.BoardSize, 50 * m_FormLogin.BoardSize);
        ...
        public void MoveAction(Coin i_Coin)
        {
            ...
            if(m_OtheloGame.CurrPlayer.PlayerType == ePlayerType.COMPUTER)
            {
                Text = "Othello- Computer's turn!";
            }
            else
            {
                Text = string.Format("Othello- {0}'s turn!", m_OtheloGame.CurrPlayer.Name);
